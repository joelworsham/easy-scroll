...
module.exports = function (grunt) {
    ...
    grunt.initConfig({
        ...
        uglify: {
            ...
            src: {
                files: {
                    'src/assets/js/easy-scroll.min.js': ['src/assets/js/source/**/*.js', '!src/assets/js/source/admin/**/*.js']
                }
            },
            admin: {
                files: {
                    'src/assets/js/easy-scroll-admin.min.js': ['src/assets/js/source/admin/*.js']
                }
            }
        },
        ...
        sass: {
            ...
            src: {
                files: {
                    'src/assets/css/easy-scroll.min.css': 'src/assets/scss/main.scss'
                }
            },
            admin: {
                files: {
                    'src/assets/css/easy-scroll-admin.min.css': 'src/assets/scss/admin/admin.scss'
                }
            }
        },
